...
public:
  ...
  typedef enum _XSTATES XSTATE;
    ...
    enum SEVERITY {
      ...
      //
      //   Note that CMDOUT_LVL and CMDERR_LVL are special cases - these are used
      ...
      CMDOUT_LVL   = -2,            // output generated by operator commands
      CMDERR_LVL   = -1,            // errors generated by operator commands
      TRACE_LVL    = 0,             // I/O trace messages
      DEBUG_LVL    = TRACE_LVL+1,   // debugging messages
      WARNING_LVL  = DEBUG_LVL+1,   // warning messages
      ERROR_LVL    = WARNING_LVL+1, // severe error messages
      ABORT_LVL    = ERROR_LVL+1,   // severe error that aborts this program
      NOLOG_LVL    = 99999,         // imaginary level that disables all logging
    };
