...
BEGIN_EVENT_TABLE(GuiPico, GuiElf)
	...
	EVT_TEXT(XRCID("KeyFilePico"), GuiMain::onKeyFileText)
	EVT_BUTTON(XRCID("KeyFileButtonPico"), GuiMain::onKeyFile)
	EVT_BUTTON(XRCID("EjectKeyFilePico"), GuiMain::onKeyFileEject)
	...
	EVT_CHECKBOX(XRCID("InterlacePico"), GuiMain::onInterlace)
	...
	EVT_BUTTON(XRCID("Rom1Pico"), GuiPico::onRom1)
	EVT_TEXT(XRCID("MainRom2Pico"), GuiMain::onMainRom2Text)
	EVT_COMBOBOX(XRCID("MainRom2Pico"), GuiMain::onMainRom2Text)
	EVT_BUTTON(XRCID("RomButton2Pico"), GuiMain::onMainRom2)

	EVT_BUTTON(XRCID("Rom2Pico"), GuiPico::onRom2)

	EVT_TEXT(XRCID("CharRomPico"), GuiMain::onCharRomText)
	EVT_COMBOBOX(XRCID("CharRomPico"), GuiMain::onCharRomText)
	EVT_BUTTON(XRCID("CharRomButtonPico"), GuiMain::onCharRom)

	EVT_TEXT(XRCID("StartRamPico"), GuiElf::onStartRam)
	EVT_TEXT(XRCID("EndRamPico"), GuiElf::onEndRam)
	EVT_CHOICE(XRCID("VideoTypePico"), GuiElf::onVideoType)
	EVT_CHOICE(XRCID("KeyboardPico"), GuiElf::onElfKeyboard)
	EVT_CHECKBOX(XRCID("UpperCasePico"), GuiElf::onForceUpperCase)
    EVT_CHECKBOX(XRCID("GiantPico"), GuiElf::onGiantBoardMapping)
    EVT_CHECKBOX(XRCID("EFButtonsPico"), GuiElf::onEfButtons)

	EVT_CHOICE(XRCID("DiskTypePico"), GuiElf::onDiskType)
	EVT_CHOICE(XRCID("MemoryPico"), GuiPico::onMemoryPico)
	...
	EVT_CHECKBOX(XRCID("PortExtPico"), GuiElf::onUsePortExtender)
    EVT_CHECKBOX(XRCID("ControlWindowsPico"), GuiPico::onPicoControlWindows)
	EVT_CHECKBOX(XRCID("AutoBootPico"), GuiElf::onAutoBoot)
	EVT_TEXT(XRCID("BootAddressPico"), GuiPico::onBootAddress)
	EVT_BUTTON(XRCID("KeyMapPico"), Main::onHexKeyDef)
	...
	EVT_BUTTON(XRCID("RealCasLoadPico"), GuiMain::onRealCas)
	...
	EVT_BUTTON(XRCID("TapePico"), GuiElf::onTape)
	...
	EVT_TEXT(XRCID("ShowAddressPico"), GuiMain::onLedTimer)
    ...
    EVT_CHECKBOX(XRCID("BootStrapPico"), GuiElf::onBootStrap)
    EVT_CHECKBOX(XRCID("HexEfPico"), GuiElf::onHexEf)
    EVT_CHOICE(XRCID("TilTypePico"), GuiElf::onTilType)
...
void GuiPico::readPicoConfig()
{
    ...
    conf[elfType].configurationDir_ = iniDir_ + "Configurations" + pathSeparator_ + "Pico" + pathSeparator_;
    conf[elfType].mainDir_ = readConfigDir("/Dir/"+elfTypeStr+"/Main", dataDir_ + "Pico" + pathSeparator_);
	conf[elfType].romDir_[MAINROM1] = readConfigDir("/Dir/"+elfTypeStr+"/Main_Rom_1_File", dataDir_ + "Pico" + pathSeparator_);
	conf[elfType].romDir_[MAINROM2] = readConfigDir("/Dir/"+elfTypeStr+"/Main_Rom_2_File", dataDir_ + "Pico" + pathSeparator_);
	conf[elfType].charRomDir_ = readConfigDir("/Dir/"+elfTypeStr+"/Font_Rom_File", dataDir_ + "Pico" + pathSeparator_);
	elfConfiguration[elfType].vtCharRomDir_ = readConfigDir("/Dir/"+elfTypeStr+"/Vt_Font_Rom_File", dataDir_ + "Pico" + pathSeparator_);
	conf[elfType].ramDir_ = readConfigDir("/Dir/"+elfTypeStr+"/SWD", dataDir_ + "Pico" + pathSeparator_);
	conf[elfType].ideDir_ = readConfigDir("/Dir/"+elfTypeStr+"/Ide_File", dataDir_ + "Pico" + pathSeparator_);
	conf[elfType].keyFileDir_ = readConfigDir("/Dir/"+elfTypeStr+"/Key_File", dataDir_ + "Pico" + pathSeparator_);
	conf[elfType].printFileDir_ = readConfigDir("/Dir/"+elfTypeStr+"/Print_File", dataDir_ + "Pico" + pathSeparator_);
	conf[elfType].screenDumpFileDir_ = readConfigDir("/Dir/"+elfTypeStr+"/Video_Dump_File", dataDir_ + "Pico" + pathSeparator_);
	conf[elfType].wavFileDir_[0] = readConfigDir("/Dir/"+elfTypeStr+"/Wav_File", dataDir_ + "Pico" + pathSeparator_);
	elfConfiguration[elfType].vtWavFileDir_ = readConfigDir("/Dir/" + elfTypeStr + "/Vt_Wav_File", dataDir_ + "Pico" + pathSeparator_);
...
/*#ifdef __WXMAC__
    ...
    setMemoryPico(elfTypeStr, elfType, elfConfiguration[elfType].memoryType);
...
void GuiPico::onMemoryPico(wxCommandEvent&event)
{
	setMemoryPico(computerInfo[selectedComputer_].gui, selectedComputer_, event.GetSelection());
}

void GuiPico::setMemoryPico(wxString elfTypeStr, int elfType, int Selection)
{
...
void GuiPico::onPicoControlWindows(wxCommandEvent&event)
{
    ...
    p_Pico->Show(elfConfiguration[runningComputer_].useElfControlWindows);
}

void GuiPico::onRom1(wxCommandEvent&WXUNUSED(event))
{
	if (loadromMode_[0] == ROM)
	{
		loadromMode_[0] = RAM;
...
void GuiPico::onRom2(wxCommandEvent&WXUNUSED(event))
{
...
int GuiPico::getLoadromModePico(int num)
{
