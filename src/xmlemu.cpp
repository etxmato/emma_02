...
{
    if (currentComputerConfiguration.statusBarType == STATUSBAR_VIP2)
    {
        if (currentComputerConfiguration.cdp1861Configuration.defined || currentComputerConfiguration.cdp1862Configuration.defined)
...
void Computer::startComputer()
{
    ...
    switch (currentComputerConfiguration.statusBarType)
    {
        case STATUSBAR_COMX:
        case STATUSBAR_DIAG:
            if (currentComputerConfiguration.vis1870Configuration.defined)
...
Byte Computer::readMemDebug(Word address, int function)
{
    ...
    int returnValue = readMemIo(address, function);
    if (returnValue != -1)
        return returnValue;
...
int Computer::readMemIo(Word address, int function)
{
    for (std::vector<MemoryPartConfiguration>::iterator ramPartConfigIterator = currentComputerConfiguration.memoryRamPartConfiguration.begin (); ramPartConfigIterator != currentComputerConfiguration.memoryRamPartConfiguration.end (); ++ramPartConfigIterator)
    {
        if (address >= ramPartConfigIterator->start && address <= ramPartConfigIterator->end)
...
void Computer::writeMemDebug(Word address, Byte value, bool writeRom)
{
    ...
    writeMemIo(address, value, writeRom);
...
void Computer::writeMemIo(Word address, Byte value, bool writeRom)
{
    for (std::vector<MemoryPartConfiguration>::iterator ramPartConfigIterator = currentComputerConfiguration.memoryRamPartConfiguration.begin (); ramPartConfigIterator != currentComputerConfiguration.memoryRamPartConfiguration.end (); ++ramPartConfigIterator)
    {
        if (address >= ramPartConfigIterator->start && address <= ramPartConfigIterator->end)
...
void Computer::resetPressed()
{
    ...
    if (currentComputerConfiguration.vis1870Configuration.defined)
    {
        if (currentComputerConfiguration.statusBarType != STATUSBAR_NONE)
...
void Computer::configureExtensions()
{
    ...
    for (std::vector<Cdp1878Configuration>::iterator cdp1878 = currentComputerConfiguration.cdp1878Configuration.begin (); cdp1878 != currentComputerConfiguration.cdp1878Configuration.end (); ++cdp1878)
    {
        ...
        cdp1878InstancePointer[numberOfCdp1878Instances_]->configureCdp1878(*cdp1878, computerClockSpeed_);
...
void Computer::configureV1870Extension()
{
    if (currentComputerConfiguration.vis1870Configuration.defined)
    {
        ...
        vis1870Pointer = new VIS1870(p_Main->getRunningComputerText() + " - VIS 1870", p_Main->getV1870Pos(), wxSize(240*zoom,216*zoom), zoom, computerClockSpeed_, currentComputerConfiguration.vis1870Configuration, currentComputerConfiguration.statusBarType);
