...
start:     sex     r2                  ; set X to stack
           ...
           plo     r5
#endif
           ldi     0                   ; get temporary stack
           phi     r2
           ldi     0ffh          
           plo     r2
           sep     scall               ; copy definitions to low memory
           dw      copy
           ldi     50h
           phi     r2
           ldi     0
...
; ************************************************
           ...
           lda     r9                  ; get high of start of memory
           phi     rb                  ; place into reg for memtest
           ldn     r9                  ; get low of memory start
           plo     rb
           inc     rb
           inc     rb
...
copy:      ldi     high storage        ; setup destination
           phi     r8
           ldi     low storage
           plo     r8
           ldi     high inst           ; setup source
           phi     r9
           ldi     low inst
           plo     r9
           ldi     high (progend-inst) ; setup count
           phi     rc
           ldi     low (progend-inst)
           plo     rc
           inc     rc
           inc     rc
copylp:    lda     r9
           ...
           ghi     rc
           lbnz    copylp
           ldi     high jump           ; setup dynamic jump
           phi     r8
           ldi     low jump
           plo     r8
           ldi     0c0h
           str     r8
           ldi     high freemem         ; setup memory pointer
           phi     r8
           ldi     low freemem         ; setup memory pointer
           plo     r8
           ldi     high datalen        ; get memory pointer
           phi     r9
           ldi     low datalen
           plo     r9
           lda     r9
...
new:       lbr     start
#else
new:       ldi     high start          ; get address of main start
...
hello:     db      'Rc/Forth 0.1',10,13
           db      '(c) copyright 2006 by Michael H. Riley'
crlf:      db       10,13,0
prompt:    db      'ok ',0
