...
; TINYOSTS By Richard Peters, Richard11092000@cox.net
...
; me please call it TINYOSTS. There was many versions of 
...
; Now uses Mike's BIOS serial functions. Baud is assumed already set
...
;
LDI0       EQU     90H       GHI R0 - CLEAR ACCUM. MACRO
...
AESTK      DW      0x0000     RANDOM NUMBER GEN.
           ...
           DW      0x0000     VAR. Y
           DW      0x0000     VAR. Z
Z1165      PHI     R0         I/O ROUTINES CLEAR LDI0
...
BRKTST     ADI     0          BREAK TEST
           ...
           SMI     0
Z157       RETURN
GRINPUT    CALL    SERINPUT
           RETURN
GROUTPUT   CALL    SEROUTPUT
           RETURN
           ORG     #2100
