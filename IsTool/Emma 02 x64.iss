...
Source: ..\Configurations Windows\FRED\*.*; DestDir: {app}\Configurations\FRED; Components: MAIN
...
Source: ..\data\FRED\*.*; DestDir: {app}\data\FRED; Components: MAIN
