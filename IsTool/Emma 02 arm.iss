...
[Files]
Source: vc_redist.arm64.exe; DestDir: {tmp}; Flags: deleteafterinstall; Components: MAIN
Source: ..\ARM64\Release\Emma 02.exe; DestDir: {app}; Components: MAIN; Tasks: ; Languages: 
...
Source: ..\..\SDL2-2.0.5\lib\arm64\SDL2.dll; DestDir: {app}; Components: MAIN
Source: ..\..\libserialport\ARM64\lib\libserialport.dll; DestDir: {app}; Components: MAIN
...
[Run]
Filename: {tmp}\vc_redist.arm64.exe; Parameters: /quiet; Components: MAIN
